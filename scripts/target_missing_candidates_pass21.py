...
OUTPUT_DIR = DATA / "missing_target_ocr"
OUTPUT_LOG = DATA / "missing_target_pass21.json"
...
def main():
    ...
    for item in items:
        ...
        found = None
        found_page = None
        for page in range(max(1, approx_page - 3), approx_page + 4):
            raster_path = OUTPUT_DIR / f"{spec}_p{page}.png"
    ...
    print("Target missing candidates pass complete.")
